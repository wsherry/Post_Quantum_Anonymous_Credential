...
# MODIFY THE FOLLOWING WHEN RUNNING ISSUE OR VERIFY TESTS

# FOR ISSUE TESTS UNCOMMENT: 
# kappa = 128     # security parameter
# d = 128         # degree of polynomial ring
# q = 67108837 * 4294966997

# FOR VERIFY TESTS UNCOMMENT: 
kappa = 128     # security parameter
d = 512         # degree of polynomial ring
q = 67108837  # modulus prime
...
def append_result(data):
    csv_file = 'test_ISSUE_results.csv'
    data= ", ".join(data)
...
def abdlop_quadratic_poly(m1, m2, ell, n, k, N, M, lambd,
    ...
    """
    print("inside quad poly", is_opti)
    start = time.perf_counter()
